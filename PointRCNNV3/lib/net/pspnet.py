...
import lib.net.caffe_pb2 as caffe_pb2
from lib.net.layers import *
...
class pspnet(nn.Module):
    ...
    def __init__(self, 
        ...
        # self.load_pretrained_model(model_path = '../../CVPointRCNNV2/Caffe-PSPNet/pspnet101_cityscapes.caffemodel')
